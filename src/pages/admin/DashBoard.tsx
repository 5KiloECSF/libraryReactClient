                ...
                <div className="flex flex-col">
                    ...
                    <div className="my-6">
                        <div className="flex flex-row space-x-4 items-center">
                            <div id="icon">
                                <span>
                                    <svg className="w-20 h-20 fill-stroke text-yellow-400" fill="none"
                            ...
                            <div id="temp">
                                <h5 className="text-4xl">120 Books</h5>
                                <p className="text-xs text-gray-500">200 promised books</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full place-items-end text-right border-t-2 border-gray-100 mt-2">
                        <a href="#" className="text-indigo-600 text-xs font-medium">View Books</a>
                    </div>
                </div>
            </div>
...
function StaticCard({svg1, svg2, title}) {
    return (
...
const ButtonsCard=()=>{
    return<div
        className="w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-md duration-300 hover:scale-105 hover:shadow-xl">
        <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto mt-8 h-16 w-16 text-green-400" viewBox="0 0 20 20"
             fill="currentColor">
        ...
        <div className="space-x-4 bg-gray-100 py-4 text-center">
            <button
                className="inline-block rounded-md bg-red-500 px-10 py-2 font-semibold text-red-100 shadow-md duration-75 hover:bg-red-400">Cancel
            </button>
            <button
                className="inline-block rounded-md bg-green-500 px-6 py-2 font-semibold text-green-100 shadow-md duration-75 hover:bg-green-400">Dashboard
            </button>
        </div>
    </div>
}
export default function Dashboard() {
    return <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <StaticCard title={"Borrowed books"} svg1={<GreenBoardSvg/>} svg2={<GreenUpSvg/>}/>
        <StaticCard title={"Returned books"} svg1={<SvgRedBoard/>} svg2={<SvgRedDown/>}/>
        <TempCard/>
        <StaticsCard/>
        <StaticsCard2/>
        <StaticsCard/>
